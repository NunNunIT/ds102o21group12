...
# Kết thúc Code của Tân

#########################################################################################
# HTTPS WEB
app = Flask(__name__)

def run_model_directly(label):
    # This function calls getLable() directly instead of calling through a POST request.
...
def test():
    test_data = "Phòng đẹp nhưng giá đắt."
    response = run_model_directly(test_data)
...
def home():
    ...
    return render_template_string('''
        ...
        <body>
            <div class="container">
                <div style="padding-bottom: 1.5rem; width: 100%; height: 100%; background: #18181b; display: flex; flex-direction: column; justify-content: start; align-items: center;">
                    <div>
                    ...
                    <form style="width: 100%; display: flex; flex-direction: column; justify-content: center; align-items: center;" action="/" method="post">
                        <div style="display: flex; width: 100%; margin: 0 auto;">
                            <div style="width: 90%; max-width: 800px; margin: 0 auto; display: flex; gap: 0.5rem; margin-top: 1.5rem; padding-left: 1rem; padding-right: 1rem;">
                ...
                <div style="position: sticky; top: 0; right: 0; padding: 0 1.5rem; margin-bottom: 1rem; display: flex; flex-direction: column; gap: 1rem; justify-content: flex-start; height: fit-content;"> 
                    ...
                    {% if result %}
                        ...
                        <div style="color: white;">
                            <p class="font-size: 1rem;">{{ result.text }}</p>
                        </div>
                    {% endif %}
                </div>
            </div>
...
# This part is not needed on Vercel because Vercel will automatically call the Flask application
